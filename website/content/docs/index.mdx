...
- **Centralization Risks**: AI models often rely on centralized infrastructure, conflicting with Web3's decentralized ethos.
...
- **Complex Development**: Building AI-native DApps requires navigating disconnected tools for smart contracts, model deployment, and data orchestration.
...
To address these issues, we have launched Metis SDK — a decentralized framework dedicated to 
building an open, transparent, high-performance, secure, and inclusive AI + Web3 ecosystem.
