...
You can complete the locking process through the [Sequencer Mining](https://sequencer.metis.io/) page. Alternatively, you can interact directly with the [contract](/sequencer/operation/natspec) to bypass the frontend operations.
